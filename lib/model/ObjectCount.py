...
cred = r"C:\GithubRepos\Hima-Local-Repo\Hima-Front-End\lib\model\hima-front-end-firebase-adminsdk-ilbe6-21df361235.json" #C:\GithubRepos\Hima-Local-Repo\Hima-Front-End\lib\model\hima-front-end-firebase-adminsdk-ilbe6-21df361235.json
...
YOLOmodel=YOLO(r"C:\GithubRepos\Hima-Local-Repo\Hima-Front-End\lib\model\YOLOv8L(368).pt") #Loading our custom model
...
def redistribute(): 
    ...
    officers_sum=sum(areas.values()) #100 Sum of all available officers
